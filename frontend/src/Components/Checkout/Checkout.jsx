          ...
          <div className='flex flex-col w-full '>
            ...
            <div className='mt-6'>
              ...
              <div className='col-span-12 mt-4'>
                ...
                <input type="text" required value={field.address} className='border-[1px] border-gray-200 rounded-md w-full px-4 py-2 focus:ring-black focus:border-none focus:ring-[1px]' placeholder='Enter your Delivery Address' onChange={(e) => {
                  setField({
                    ...field,
