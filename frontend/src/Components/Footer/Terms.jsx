...
const Terms = () => {
    return (
        <div className='lg:p-20 py-20 px-4'>
            <div>
                <h1 className='lg::text-7xl md:text-6xl text-3xl relative after:absolute after:left-[39%] after:right-[50%] md:after:top-[7rem] after:top-[3.4rem]  font-extrabold text-center after:w-[20%] after:h-[4px] after:bg-[#ffe600] '>Terms & Conditions</h1>
            </div>
            ...
            <div className="md:mt-32 mt-20  text-[#777] ">
                ...
                <div className="mt-10 text-lg">
                    <h1 className='text-xl font-semibold text-black'>AGREEMENT TO TERMS</h1>
                    <p className="mt-5">
                        These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Now eStore Pvt. Ltd., doing business as The Books Platform (“The Books Platform“, “we”, “us”, or “our”), concerning your access to and use of the <Link to='https://booksplatform-shpg.vercel.app/' className='text-blue-500 underline'>https://booksplatform-shpg.vercel.app/</Link> website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms and Conditions. <br /><br />
                ...
                <div className="mt-10 text-lg">
                    <h1 className='text-xl font-semibold text-black'>INTELLECTUAL PROPERTY RIGHTS</h1>
                    <p className="mt-5">
                ...
                <div className="mt-10 text-lg">
                    <h1 className='text-xl font-semibold text-black'>USER REPRESENTATIONS</h1>
                    <p className="mt-5">
